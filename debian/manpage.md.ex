% gnome-shell-extension-display-switcher(SECTION) | User Commands
%
% "January 24 2024"
...
gnome-shell-extension-display-switcher - program to do something

# SYNOPSIS

**gnome-shell-extension-display-switcher** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**gnome-shell-extension-display-switcher** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **gnome-shell-extension-display-switcher** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**gnome-shell-extension-display-switcher** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    gnome-shell-extension-display-switcher. See **foo.conf**(5) for further details.
...
**gnome-shell-extension-display-switcher** provides some return codes, that can be used in scripts:
